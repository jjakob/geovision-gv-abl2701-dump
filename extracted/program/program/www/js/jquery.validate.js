...
(function($) {
    ...
    $.extend($.fn, {
                    ...
                    function handle() {
                        if (validator.settings.submitHandler) {
                            if (validator.submitButton) {
                                ...
                                var hidden = $("<input type='hidden'/>").attr("name", validator.submitButton.name).val(
        ...
        rules : function(command, argument) {
            ...
            var data = $.validator.normalizeRules($.extend( {}, $.validator.metadataRules(element), $.validator
                    .classRules(element), $.validator.attributeRules(element), $.validator.staticRules(element)),
                    element);
            ...
            .extend(
                    $.validator,
                    {
                        ...
                        onfocusout : function(element) {
                            if (!this.checkable(element) && this.validable(element)) {
                        ...
                        onclick : function(element) {
                            ...
                            if (element.name in this.submitted)
                                this.element(element);
                            // or option elements, check parent select in that
                            // case
                        ...
                        // Modified by jinxuefei 00331, 2012/06/20 PN:VVD68729
                        messages : {
                            required : $.lang.validate["valRequired"],
                            remote : $.lang.validate["valRemote"],
                            email : $.lang.validate["valEmail"],
                            url : $.lang.validate["valUrl"],
                            date : $.lang.validate["varDate"],
                            dateISO : $.lang.validate["valDateISO"],
                            number : $.lang.validate["valNumber"],
                            digits : $.lang.validate["valDigits"],
                            integer : $.lang.validate["valInteger"],
                            creditcard : $.lang.validate["valCreditcard"],
                            equalTo : $.lang.validate["valEqualTo"],
                            accept : $.lang.validate["valAccept"],
                            maxlength : jQuery.validator.format($.lang.validate["valMaxlength"]),
                            minlength : jQuery.validator.format($.lang.validate["valMinlength"]),
                            rangelength : jQuery.validator.format($.lang.validate["valRangelength"]),
                            range : jQuery.validator.format($.lang.validate["valRange"]),
                            max : jQuery.validator.format($.lang.validate["valMax"]),
                            min : jQuery.validator.format($.lang.validate["valMin"]),
                            userDefinedCheckIPAndMask : $.lang.tip["tipIPAndSubnetMaskErr"],
                            userDefinedCheckIPAndMaskSameNet : $.lang.tip["tipIPAndGWNotSameNetwork"],
                            CheckIPv6AddressAndGatewayEqual:$.lang.tip["tipIPAndGWNotEqual"]
                        },
                        ...
                        prototype : {
                            ...
                            init : function() {
                                ...
                                if (this.settings.errorElement) {
                                    $(this.settings.errorElement + '[generated="true"]').remove();
                                }
                            },
                            ...
                            // Modified by jinxuefei 00331, 2012/06/20
                            // PN:VVD68729
                            checkForm : function() {
                                this.prepareForm();
                                for ( var i = 0, elements = (this.currentElements = this.elements()); elements[i]; i++) {
                                    ...
                                    this.check(elements[i], objParam);
                                }
                                return this.valid();
                            },
                            ...
                            element : function(element, objParam) {
                                element = this.clean(element);
                                this.lastElement = element;
                                this.prepareElement(element);
                                this.currentElements = $(element);
                                var result = this.check(element, objParam);
                                if (result) {
                                ...
                                if (this.settings.focusInvalid) {
                                    try {
                                        ...
                                        // manually trigger focusin event;
                                                // without it, focusin handler
                                                // isn't
                                                // called, findLastActive won't
                                                // have
                                                // anything to find
                                                .trigger("focusin");
                                    } catch (e) {
                            ...
                            elements : function() {
                                ...
                                return $( []).add(this.currentForm.elements).filter(":input").not(
                                        ...
                                        function() {
                                            ...
                                            // select only the first element for
                                            // each name, and only those with
                                            // rules specified
                            ...
                            // Modified by jinxuefei 00331, 2012/06/20
                            // PN:VVD68729
                            check : function(element, objParam) {
                                element = this.clean(element);
                                ...
                                if (("object" == typeof (objParam)) && (true === objParam.bIsRelationChk)) {
                                    var rule = {
                                        method : objParam.method,
                                        parameters : rules[objParam.method]
                                    };
                                    var ret = $.validator.methods[rule.method].call(this, element.value.replace(/\r/g,
                                ...
                                for (method in rules) {
                                    ...
                                    try {
                                        if (("relationTo" == method) && objParam && (true === objParam.bIsCheckForm)) {
                                            continue;
                                        }
                            ...
                            customMetaMessage : function(element, method) {
                                ...
                                var meta = this.settings.meta ? $(element).metadata()[this.settings.meta] : $(element)
                                        .metadata();
                            ...
                            defaultMessage : function(element, method) {
                                return this.findDefined(this.customMessage(element.name, method),
                                        ...
                                        $.validator.messages[method], "<strong>Warning: No message defined for "
                                                + element.name + "</strong>");
                            },
                            ...
                            showTip : function(element) {
                                var message = this.validable(element);
                                if (!message)
                                    return;
                                var label = this.errorsFor(element);
                                var lastMsg=label.text();
                                if (label.length) {
                                    // refresh error/success class
                                    label.removeClass().addClass(this.settings.errorClass).addClass(
                            ...
                            showLabel : function(element, message) {
                                var tip = this.validable(element);
                                if (!tip)
                                    return;
                                var label = this.errorsFor(element);
                                var lastMsg=label.text();
                                ...
                                if (!message && this.settings.success) {
                                    label.text("");
                                    typeof this.settings.success == "string" ? label.addClass(this.settings.success)
                            ...
                            validable : function(element) {
                                var message = $("#" + this.idOrName(element)).attr('tip');
                        ...
                        addClassRules : function(className, rules) {
                            className.constructor == String ? this.classRuleSettings[className] = rules : $.extend(
                        ...
                        methods : {
                            ...
                            required : function(value, element, param) {
                                ...
                                switch (element.nodeName.toLowerCase()) {
                                    case 'select':
                                        // could be an array for select-multiple
                                        // or a string, both are fine this way
                                        var val = $(element).val();
                            ...
                            // Added by jinxuefei 00331, 2012/06/20 PN:VVD68729
                            relationTo : function(value, element, param) {
                                var validator = $.data(element.form, 'validator');
                                if (validator) {
                                    param = [].concat(param);
                                    for ( var i = 0; i < param.length; i++) {
                                        if (param[i].id && param[i].method) {
                                            var obj = {
                                                method : param[i].method,
                                                bIsRelationChk : true
                                            };
                                            validator.element($(param[i].id)[0], obj);
                                        }
                                    }
                                }
                                return true;
                            ...
                            // Added by jinxuefei 00331, 2012/06/20 PN:VVD68729
                            userDefinedCheckIPAndMask : function(value, element, param) {
                                var nmStr = $(param).val();
                                var ipStr = value;
                                ...
                                var ipaddr = (ip[0] << 24) | (ip[1] << 16) | (ip[2] << 8) | (ip[3]);
                                var netmask = (nm[0] << 24) | (nm[1] << 16) | (nm[2] << 8) | (nm[3]);

                                // network address
                                var segment = ipaddr & (~netmask);
                                // broadcast address
                                var bcastip = ipaddr | netmask;

                                return !((0 == segment) || (-1 == bcastip));


                            },

                            CheckIPv6AddressAndGatewayEqual:function(value, element, param){
                                var list = param.split(",");
                                var address = $(list[0]).val(),
                                    gate = $(list[1]).val();
                            ...
                            userDefinedCheckIPAndMaskSameNet : function(value, element, param) {
                                var list = param.split(",");
                                var ipStr = $(list[0]).val();
                                var nmStr = $(list[1]).val();
                                var gwStr = $(list[2]).val();

                                if ((0 == ipStr.length) || ("0.0.0.0" == ipStr)) {
                                    return false;
                                }

                                if ((0 == gwStr.length) || ("0.0.0.0" == gwStr)) {
                                    return true;
                                }
                                ...
                                var ipaddr = (ip[0] << 24) | (ip[1] << 16) | (ip[2] << 8) | (ip[3]);
                                var netmask = (nm[0] << 24) | (nm[1] << 16) | (nm[2] << 8) | (nm[3]);
                                var gateway = (gw[0] << 24) | (gw[1] << 16) | (gw[2] << 8) | (gw[3]);
                                var net_ip = ipaddr & netmask;
                                var net_gw = gateway & netmask;

                                return (net_ip == net_gw);
                            }
                        }
