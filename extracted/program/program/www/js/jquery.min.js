...
(function(E, B) {
    function ka(a, b, d) {
        if (d === B && a.nodeType === 1) {
            ...
            if (typeof d === "string") {
                try {
                    d = d === "true" ? true : d === "false" ? false : d === "null" ? null : !c.isNaN(d) ? parseFloat(d)
    ...
    function da(a, b, d, e) {
        if (c.isArray(b) && b.length)
            c.each(b, function(f, h) {
                d || Ra.test(a) ? e(a, h) : da(a + "[" + (typeof h === "object" || c.isArray(h) ? f : "") + "]", h, d,
                        e)
            });
    ...
    var t = E.document, c = function() {
        ...
        b.extend( {
            ...
            makeArray : function(j, s) {
                ...
                if (j != null) {
                    var z = b.type(j);
                    j.length == null || z === "string" || z === "function" || z === "regexp" || b.isWindow(j) ? M.call(
                            v, j) : b.merge(v, j)
                }
                return v
            },
    ...
    (function() {
        ...
        var f = d.getElementsByTagName("*"), h = d.getElementsByTagName("a")[0], l = t.createElement("select"), k = l
    ...
    c.extend( {
        ...
        attr : function(a, b, d, e) {
            ...
            if ((b in a || a[b] !== B) && e && !h) {
                ...
                if (b === "tabIndex")
                    return (b = a.getAttributeNode("tabIndex")) && b.specified ? b.value : Va.test(a.nodeName)
    ...
    c.event = {
        ...
        remove : function(a, b, d, e) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                if (d === false)
                    d = U;
                var f, h, l = 0, k, o, x, r, A, C, J = a.nodeType ? "events" : "__events__", w = c.data(a), I = w
                        && w[J];
                if (w && I) {
        ...
        trigger : function(a, b, d, e) {
            ...
            if (!a.isPropagationStopped() && e)
                ...
                if ((!x._default || x._default.call(d, a) === false) && !o
    ...
    (function() {
        ...
        var k = function(g, i, n, m) {
            ...
            if (D.length > 1 && x.exec(g))
                ...
                if (!m && D.length > 1 && i.nodeType === 9 && !O && o.match.ID.test(D[0])
                ...
                if (i) {
                    q = m ? {
                        expr : D.pop(),
                        set : C(m)
                    } : k.find(D.pop(), D.length === 1 && (D[0] === "~" || D[0] === "+") && i.parentNode ? i.parentNode
                            : i, O);
        ...
        var o = k.selectors = {
            ...
            preFilter : {
                ...
                CHILD : function(g) {
                    if (g[1] === "nth") {
                        var i = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(g[2] === "even" && "2n" || g[2] === "odd" && "2n+1"
            ...
            filter : {
                ...
                ATTR : function(g, i) {
                    ...
                    var m = n + "", p = i[2], q = i[4];
                    return n == null ? p === "!=" : p === "=" ? m === q : p === "*=" ? m.indexOf(q) >= 0
                            : p === "~=" ? (" " + m + " ").indexOf(q) >= 0 : !q ? m && n !== false
                                    : p === "!=" ? m !== q : p === "^=" ? m.indexOf(q) === 0 : p === "$=" ? m
                                            .substr(m.length - q.length) === q : p === "|=" ? m === q
                ...
                o.find.ID = function(m, p, q) {
                    if (typeof p.getElementById !== "undefined" && !q)
                        return (p = p.getElementById(m[1])) ? p.id === m[1]
                                ...
                                && p.getAttributeNode("id").nodeValue === m[1] ? [ p ] : B : []
                };
        ...
        (function() {
            var g = t.documentElement, i = g.matchesSelector || g.mozMatchesSelector || g.webkitMatchesSelector
    ...
    c.fn.extend( {
        ...
        html : function(a) {
            ...
            else if (typeof a === "string" && !Ca.test(a) && (c.support.leadingWhitespace || !$.test(a))
            ...
            if (this[0]) {
                ...
                if (f = h.childNodes.length === 1 ? h = h.firstChild : h.firstChild) {
                    ...
                    for ( var o = this.length; f < o; f++)
                        d.call(b ? c.nodeName(this[f], "table") ? this[f].getElementsByTagName("tbody")[0]
                                || this[f].appendChild(this[f].ownerDocument.createElement("tbody")) : this[f]
    ...
    c.buildFragment = function(a, b, d) {
        ...
        if (a.length === 1 && typeof a[0] === "string" && a[0].length < 512 && b === t && !Ca.test(a[0])
                    ...
                    for ( var f = [], h = 0, l; (l = a[h]) != null; h++) {
                        ...
                        if (l) {
                            if (typeof l === "string" && !eb.test(l))
                                ...
                                l = l.replace(Aa, "<$1></$2>");
                                var k = (Ba.exec(l) || [ "", "" ])[1].toLowerCase(), o = P[k] || P._default, x = o[0], r = b
                                        .createElement("div");
                                for (r.innerHTML = o[1] + l + o[2]; x--;)
                                    r = r.lastChild;
                                if (!c.support.tbody) {
                                    x = db.test(l);
                                    k = k === "table" && !x ? r.firstChild && r.firstChild.childNodes
                    ...
                    if (w) {
                        ...
                        var L = w.onreadystatechange = function(m) {
                            if (!w || w.readyState === 0 || m === "abort") {
                                ...
                                J = true;
                                w.onreadystatechange = c.noop;
                                e = m === "timeout" ? "timeout" : !c.httpSuccess(w) ? "error" : b.ifModified
                                        && c.httpNotModified(w, b.url) ? "notmodified" : "success";
                                var p;
                                if (e === "success")
                                    try {
    ...
    c.extend( {
        speed : function(a, b, d) {
            ...
            e.duration = c.fx.off ? 0 : typeof e.duration === "number" ? e.duration
                    : e.duration in c.fx.speeds ? c.fx.speeds[e.duration] : c.fx.speeds._default;
            e.old = e.complete;
            e.complete = function() {
    ...
    c.fx.prototype = {
        ...
        step : function(a) {
            ...
            if (a || b >= this.options.duration + this.startTime) {
                ...
                this.pos = c.easing[this.options.specialEasing && this.options.specialEasing[this.prop] || b](
        ...
        step : {
            ...
            _default : function(a) {
                if (a.elem.style && a.elem.style[a.prop] != null)
                    a.elem.style[a.prop] = (a.prop === "width" || a.prop === "height" ? Math.max(0, a.now) : a.now)
                            + a.unit;
                else
                    a.elem[a.prop] = a.now
            }
    ...
    c.fn.offset = "getBoundingClientRect" in t.documentElement ? function(a) {
        ...
        f = fa(f);
        return {
            top : d.top + (f.pageYOffset || c.support.boxModel && h.scrollTop || b.scrollTop)
                    - (h.clientTop || b.clientTop || 0),
            left : d.left + (f.pageXOffset || c.support.boxModel && h.scrollLeft || b.scrollLeft)
    ...
    c.offset = {
        ...
        setOffset : function(a, b, d) {
            ...
            var f = c(a), h = f.offset(), l = c.css(a, "top"), k = c.css(a, "left"), o = e === "absolute"
    ...
    c.each( [ "Left", "Top" ], function(a, b) {
        ...
        c.fn[d] = function(e) {
            ...
            if (e !== B)
                ...
                return (h = fa(f)) ? "pageXOffset" in h ? h[a ? "pageYOffset" : "pageXOffset"] : c.support.boxModel
                        && h.document.documentElement[d] || h.document.body[d] : f[d]
        }
    });
    c.each( [ "Height", "Width" ], function(a, b) {
        var d = b.toLowerCase();
        ...
        c.fn[d] = function(e) {
            ...
            if (c.isWindow(f))
                return f.document.compatMode === "CSS1Compat" && f.document.documentElement["client" + b]
                        || f.document.body["client" + b];
            else if (f.nodeType === 9)
                return Math.max(f.documentElement["client" + b], f.body["scroll" + b], f.documentElement["scroll" + b],
